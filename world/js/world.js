class World {
    ...
    #generateTrees() {
        ...
        while (tryCount < 100) {
            ...
            //check if tree is inside or near buildings and road
            let keep = true;
            ...
            //trees too close to other trees
            if (keep) {
            ...
            // avoid trees in the middle of nowhere
            if (keep) {
    ...
    #updateLights() {
        ...
        for (const light of lights) {
            ...
            if (!point) {
                // Handle the case when no nearest point is found. For example, skip this light.
                continue;
            }        
    ...
    draw(ctx, viewPoint, showStartMarkings = true, renderRadius = 1000) {
        ...
        for (const env of this.envelopes) {
            env.draw(ctx, { fill: "#BBB", stroke: "#BBB", lineWidth: 12 });
        }
